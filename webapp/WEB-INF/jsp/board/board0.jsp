...
<body>
	...
	<script src="/static/plugins/startbootstrap/vendor/jquery/jquery.js"></script>
	<script
		src="/static/plugins/startbootstrap/vendor/bootstrap/js/bootstrap.min.js"></script>
	<script
		src="/static/plugins/startbootstrap/vendor/metisMenu/metisMenu.min.js"></script>
	<script
		src="/static/plugins/startbootstrap/vendor/raphael/raphael.min.js"></script>
	<script
		src="/static/plugins/startbootstrap/vendor/morrisjs/morris.min.js"></script>
	...
	// // $("#dashboardHome").on("click" , function(){ // // location.href
	= "/member/join"; // // }); // $(document).ready(function() { // var i
	= { // subject : "sub", // content : "con" // }; // $.ajax({ // url :
	"/api/board/start", // method : "POST", // contentType :
	"application/json; charset=utf-8", // data : JSON.stringify(i), //
	dataType : "json" // }).done(function(IdeaVo) { // //
	alert(IdeaVo.content); // }).fail(function() { // alert("실패"); // });
