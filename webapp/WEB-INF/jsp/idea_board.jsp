...
<link rel="stylesheet" href="/static/plugins/hyundo/css/reset.css">
<!-- CSS reset -->
<link rel="stylesheet" href="/static/plugins/hyundo/css/style.css">
<!-- Resource style -->
				...
				<div class="modal-content">
					<div id="page-wrap">
						...
						<div id="contact-area">
							...
							<label for="userId">NAME:</label> <input type="text"
								name="userId" id="userId" disabled="disabled" /> <label
