jQuery(document).ready(function($){
	...
	function animateSection () {
		...
		$('.cd-section').each(function(){
			...
			( offset >= -100 && offset < windowHeight ) ? actualBlock.addClass('is-visible') : actualBlock.removeClass('is-visible');
		});
	}
	...
	function nextSection() {
		if (!animating) {
			...
			console.log('checknext2'+$('.cd-section.is-visible').next());
		}
	}

	function prevSection() {
		if (!animating) {
			console.log('check prev section');
